...
ctx.strokStyle = "blue";
ctx.lineWidth = 5;
ctx.arc(x=40, y=0, r=2, startAngle, endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=350, y=210, r=2, startAngle, endAngle);
ctx.stroke();
...
ctx.strokStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x=210, y=40, r=2, startAngle, endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=300, y=250, r=2, startAngle, endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=400, y=250, r=2, startAngle, endAngle);
ctx.stroke();
